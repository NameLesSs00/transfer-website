...
export function LocationJourneysTable() {
            ...
            {listStatus === "loading" ? (
              <tr>
                <td colSpan={3} className="px-5 py-10 text-center text-sm font-medium text-[#667085]">
                  ...
                  Loading location journeys...
                </td>
              </tr>
            ) : items.length === 0 ? (
              <tr>
                <td colSpan={3} className="px-5 py-10 text-center text-sm font-medium text-[#667085]">
                  No location journeys found.
                </td>
              </tr>
            ) : (
              items.map((journey) => (
                <tr key={journey.id} className="text-sm font-medium text-transfer-dark">
                  ...
                  <td className="px-5 py-4 text-right">
                    <div className="inline-flex items-center gap-2">
                      <button
                        onClick={() => dispatch(openEditLocationJourneyModal(journey))}
                      ...
                      <button
                        onClick={() => dispatch(openDeleteLocationJourneyConfirm(journey))}
